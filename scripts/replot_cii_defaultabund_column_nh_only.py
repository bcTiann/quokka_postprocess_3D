"""Replot the default-abundance explicit-column CII spectra without NH/2."""
...
SOURCE = (
    Path(cfg.OUTPUT_DIR)
    / "CII_default_abund_HM2012_Draine_CR_explicit_column_"
      "NH_and_NHdiv2_Tsplit_Rinf_nozoom.npz"
)
OUTPUT_STEM = (
    "CII_default_abund_HM2012_Draine_CR_explicit_column_"
    "NHonly_Tsplit_Rinf_nozoom_cleanlabels"
)
SELECTED = (
    "despotic",
    "hm2012_NH",
...
def main() -> None:
    ...
    fig.suptitle(
        r"[C II] 158 $\mu$m $(N_{\rm H}, n_{\rm H}, T)$, "
        r"LOS y, $R=\infty$"
    )
    fig.tight_layout()
