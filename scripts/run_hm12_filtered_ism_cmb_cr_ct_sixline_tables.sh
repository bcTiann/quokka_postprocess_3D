...
STEM="hm2012_native_plus_filtered_ism_cmb_cr_ct_defaultabund_sixline"
...
for required in "$CIALOOP" "$COLUMN_PAR" "$JEANS_PAR" \
  "$GRACKLE_DIR/HM12_NATIVE_ISM_NH21_CMB/z_0.0000e+00.sed"; do
...
echo "Native HM2012 + filtered ISM + CMB + CR + CT six-line tables completed."
