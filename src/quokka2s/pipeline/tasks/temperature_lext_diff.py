...
# Shared intermediate-I/O helpers moved to pipeline/intermediate_io.py
# (2026-06-24); re-imported here so this legacy cross-L_ext diff task keeps
# working.  This task deliberately reads sibling dirs with DIFFERING cache keys
# (L_ext is the comparison), so it calls _load_results WITHOUT expected_key.
